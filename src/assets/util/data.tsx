...
export const imageArray = [
    { src: '/images/image-product-1.jpg', height: 244, width: 544, alt: 'image-product-1' },
    { src: '/images/image-product-2.jpg', height: 244, width: 544, alt: 'image-product-2' },
    { src: '/images/image-product-3.jpg', height: 244, width: 544, alt: 'image-product-3' },
    { src: '/images/image-product-4.jpg', height: 244, width: 544, alt: 'image-product-4' },
]
