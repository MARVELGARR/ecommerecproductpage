    ...
    return (
        <div className=''>
            ...
            <div className=" z-10">
                ...
                <div className={` ${ view ? "" : " hidden" } absolute backdrop-blur-sm backdrop-grayscale backdrop-filter flex justify-center items-center  filter  w-full z-50 top-0 right-0 bottom-0 `}>
